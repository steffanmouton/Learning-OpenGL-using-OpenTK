...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        {
            //-0.5f, -0.5f, 0.0f, .25f, .25f, .25f, 1.0f, // Bottom-left vertex
            // 0.5f, -0.5f, 0.0f, .5f, .5f, .5f, 1.0f, // Bottom-right vertex
            // 0.0f,  0.5f, 0.0f, .75f, .75f, .75f, 1.0f,  // Top vertex

             -0.5f, -0.5f, 0.0f, 1f, 0f, 0f, 1.0f, // Bottom-left vertex
             0.5f, -0.5f, 0.0f, 0f, 1f, 0f, 1.0f, // Bottom-right vertex
             0.0f,  0.5f, 0.0f, 0f, 0f, 1f, 1.0f,  // Top vertex
        };
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // =================== ADDED CODE FROM STEFFAN
            var colorValLocation = _shader.GetAttribLocation("colorValLocation");
