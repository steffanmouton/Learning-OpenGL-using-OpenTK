...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            transform *= Matrix4.CreateRotationZ(MathHelper.DegreesToRadians(_rotationZ));
            transform *= Matrix4.CreateRotationX(MathHelper.DegreesToRadians(_rotationX));
            transform *= Matrix4.CreateRotationY(MathHelper.DegreesToRadians(_rotationY));
